...
#include "../../../src/ui/tray/TrayManager.h"
...
template <> constexpr inline auto TrayManager::qt_create_metaobjectdata<qt_meta_tag_ZN11TrayManagerE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        ...
        "mode",
        "areaSelectRequested",
        "globalVisibilityToggleRequested",
        "settingsRequested",
        "exitRequested"
    };
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SignalData<void(Mode)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 3, 4 },
        }}),
        // Signal 'areaSelectRequested'
        QtMocHelpers::SignalData<void()>(5, 2, QMC::AccessPublic, QMetaType::Void),
        // Signal 'globalVisibilityToggleRequested'
...
void TrayManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->modeChangeRequested((*reinterpret_cast< std::add_pointer_t<Mode>>(_a[1]))); break;
        case 1: _t->areaSelectRequested(); break;
        case 2: _t->globalVisibilityToggleRequested(); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (TrayManager::*)(Mode )>(_a, &TrayManager::modeChangeRequested, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (TrayManager::*)()>(_a, &TrayManager::areaSelectRequested, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (TrayManager::*)()>(_a, &TrayManager::globalVisibilityToggleRequested, 2))
            return;
        if (QtMocHelpers::indexOfMethod<void (TrayManager::*)()>(_a, &TrayManager::settingsRequested, 3))
            return;
        if (QtMocHelpers::indexOfMethod<void (TrayManager::*)()>(_a, &TrayManager::exitRequested, 4))
            return;
    }
}
...
// SIGNAL 0
void TrayManager::modeChangeRequested(Mode _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void TrayManager::areaSelectRequested()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void TrayManager::globalVisibilityToggleRequested()
{
    QMetaObject::activate(this, &staticMetaObject, 2, nullptr);
}

// SIGNAL 3
void TrayManager::settingsRequested()
{
    QMetaObject::activate(this, &staticMetaObject, 3, nullptr);
}

// SIGNAL 4
void TrayManager::exitRequested()
{
